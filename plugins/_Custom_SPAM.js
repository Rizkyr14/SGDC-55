...
let [kr, psn] = text.split `|`
    ...
    if (!kr) return conn.reply(m.chat, '```Siapa yang mau di spam?```', m)
    if (!psn) return conn.reply(m.chat, '```Masukan teks pesan!```', m)
    if (text > 500) return conn.reply(m.chat, '```Teks Kepanjangan!```', m)
 
    let ss = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let sn = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s3 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s4 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s5 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s6 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s7 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s8 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s9 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s0 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s11 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s12 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s13 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s14 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s15 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s16 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s17 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s18 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s19 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s20 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s21 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s22 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s23 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s24 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s25 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s26 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s27 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s28 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s29 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s30 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s31 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s32 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s33 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s34 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s35 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s36 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s37 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s38 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s39 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s40 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s41 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s42 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s43 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s44 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s45 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s46 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s47 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s48 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s49 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s50 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s51 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s52 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s53 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s54 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s55 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s56 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s57 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s58 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s59 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s60 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s61 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s62 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s63 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s64 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s65 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s66 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s67 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s68 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s69 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s70 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s71 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s72 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s73 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s74 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s75 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s76 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s77 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s78 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s79 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s80 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s81 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s82 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s83 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s84 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s85 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s86 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s87 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s88 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s89 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s90 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s91 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s92 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s93 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s94 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s95 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s96 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s97 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s98 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s99 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
    let s100 = `*「 ANONYMOUS SPAMMER 」*\n\n*Pesan:* _${psn}_\n\n*[ • SGDC-BOT • ]*`
 ...
 await m.reply('```Proses Pengiriman 100 Pesan Spam...```')
    let kntl = `_Berhasil Mengirim Spam Ke Nomor Tujuan!_`
